...
function validarFormulario(e) {
	...
	if (terminoBusqueda === "") {
		mostrarAlerta("Agregar uin término de búsqueda");
		return;
	}
...
function buscarImagenes() {
	...
	const key = "42572868-42204e6c7d908641e7a74decf";
...
function imprimirPaginador() {
	...
	while (true) {
		...
		// Caso contrario, genera un boton por cada elemento ene el generador
